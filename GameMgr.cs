...
void Start()
{
    CRoomCreator dd = new CRoomCreator();
    dd.ExportTMX(string.Format("./Assets/Resources/Levels/004.xml", Application.streamingAssetsPath));

    // 壁オブジェクト管理生成
    Wall.parent = new TokenMgr<Wall>("Wall", 300);
    // 移動床オブジェクト管理作成
